    ...
    adm_pool_target_directory_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:459:42) - Directory[");
    ...
    adm_pool_target_directory_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:484:42) - Directory[");
        printf("%d", (pool_target->ent_directory)->identity);
        printf("] ");
        printf("Generating");
        printf(" {");
    ...
    adm_pool_target_directory_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:527:42) - Directory[");
        printf("%d", (pool_target->ent_directory)->identity);
        printf("] ");
    ...
    adm_pool_target_directory_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:573:42) - Directory[");
        printf("%d", (pool_target->ent_directory)->identity);
        printf("] ");
    ...
    adm_pool_target_directory_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:619:42) - Directory[");
        printf("%d", (pool_target->ent_directory)->identity);
        printf("] ");
        printf("Idle");
        printf(" {");
