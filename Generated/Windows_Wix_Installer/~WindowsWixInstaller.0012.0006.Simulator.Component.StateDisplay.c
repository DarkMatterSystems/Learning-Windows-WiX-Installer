    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:700:42) - Component[");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:734:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:756:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:778:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:800:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:822:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:844:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:866:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:888:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
        printf("Idle");
        printf(" {");
    ...
    adm_pool_target_component_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:911:42) - Component[");
        printf("%d", (pool_target->ent_component)->identity);
        printf("] ");
