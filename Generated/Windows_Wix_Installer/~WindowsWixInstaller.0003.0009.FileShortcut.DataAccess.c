    ...
    adm_sta_file_shortcut_typ status)
{
    ...
    ent_file_shortcut->status  = status;
    ...
    ent_file_shortcut->rel_writing_file_head = NULL;
    ent_file_shortcut->rel_writing_file_tail = NULL;
    ...
    adm_err_rank_typ error_rank)
{
    ...
    if (source_object != ent_file_shortcut) {
        ...
        if (ent_file_shortcut->rel_writing_file_head != NULL) {
    ...
    adm_err_rank_typ error_rank)
{
    ...
    #if ADM_PROBE
    adm_probe_enter(ADM_PROBE_GROUP_DATA_ACCESS, "adm_link_relation_file_shortcut_writing_file");
    #endif
    ...
    rel_file_shortcut_writing_file = ent_source_file_shortcut->rel_writing_file_head;

    while (
        file_not_found &&
        rel_file_shortcut_writing_file != NULL) {

        if (rel_file_shortcut_writing_file->ent_file == ent_target_file) {

            file_not_found = FALSE;
        }

        rel_file_shortcut_writing_file = rel_file_shortcut_writing_file->next;
    }

    if (file_not_found) {

        rel_file_shortcut_writing_file = (adm_rel_file_shortcut_writing_file_typ*)
            adm_allocate_memory(sizeof(adm_rel_file_shortcut_writing_file_typ));

        rel_file_shortcut_writing_file->ent_file = ent_target_file;

        if (ent_source_file_shortcut->rel_writing_file_head == NULL) {

            rel_file_shortcut_writing_file->back = NULL;

            ent_source_file_shortcut->rel_writing_file_head = rel_file_shortcut_writing_file;

        } else {

            rel_file_shortcut_writing_file->back = ent_source_file_shortcut->rel_writing_file_tail;

            (ent_source_file_shortcut->rel_writing_file_tail)->next = rel_file_shortcut_writing_file;
        }

        rel_file_shortcut_writing_file->next = NULL;

        ent_source_file_shortcut->rel_writing_file_tail = rel_file_shortcut_writing_file;
    ...
    #if ADM_PROBE
    adm_probe_leave(ADM_PROBE_GROUP_DATA_ACCESS, "adm_link_relation_file_shortcut_writing_file");
    #endif
}
...
{
    #if ADM_PROBE
    adm_probe_enter(ADM_PROBE_GROUP_DATA_ACCESS, "adm_kill_relation_file_shortcut_writing_file");
    #endif
    ...
    if (
        (adm_base_integer_typ)rel_file_shortcut_writing_file->next !=
        (adm_base_integer_typ)rel_file_shortcut_writing_file->ent_file) {

        if (ent_file_shortcut->rel_writing_file_head != NULL) {

            if (ent_file_shortcut->rel_writing_file_head == rel_file_shortcut_writing_file) {

                ent_file_shortcut->rel_writing_file_head = rel_file_shortcut_writing_file->next;

            } else {

                (rel_file_shortcut_writing_file->back)->next = rel_file_shortcut_writing_file->next;
            }

            if (ent_file_shortcut->rel_writing_file_tail == rel_file_shortcut_writing_file) {

                ent_file_shortcut->rel_writing_file_tail = rel_file_shortcut_writing_file->back;

            } else {

                (rel_file_shortcut_writing_file->next)->back = rel_file_shortcut_writing_file->back;
            }

            adm_deallocate_memory(rel_file_shortcut_writing_file);
    ...
    #if ADM_PROBE
    adm_probe_leave(ADM_PROBE_GROUP_DATA_ACCESS, "adm_kill_relation_file_shortcut_writing_file");
    #endif
}
