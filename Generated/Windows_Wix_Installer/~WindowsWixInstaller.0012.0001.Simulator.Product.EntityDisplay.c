    ...
    while (ent_product != NULL) {
        ...
        switch (ent_product->status) {
            case ADM_STATUS_PRODUCT_CREATING :
                printf("%-*s", width_product.status, "Creating");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_PRODUCT :
                printf("%-*s", width_product.status, "Generating_Product");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_PACKAGE :
                printf("%-*s", width_product.status, "Generating_Package");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_PROPERTY :
                printf("%-*s", width_product.status, "Generating_Property");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_ICON :
                printf("%-*s", width_product.status, "Generating_Icon");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_DIRECTORY :
                printf("%-*s", width_product.status, "Generating_Directory");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_FEATURE :
                printf("%-*s", width_product.status, "Generating_Feature");
            break;
            case ADM_STATUS_PRODUCT_GENERATING_MISCELLANEOUS :
                printf("%-*s", width_product.status, "Generating_Miscellaneous");
            break;
            case ADM_STATUS_PRODUCT_IDLE :
                printf("%-*s", width_product.status, "Idle");
            break;
            default :
