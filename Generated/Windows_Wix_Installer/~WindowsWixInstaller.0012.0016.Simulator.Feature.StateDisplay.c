    ...
    adm_pool_target_feature_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:1424:42) - Feature[");
    ...
    adm_pool_target_feature_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:1449:42) - Feature[");
        printf("%d", (pool_target->ent_feature)->identity);
        printf("] ");
        printf("Generating");
        printf(" {");
    ...
    adm_pool_target_feature_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:1519:42) - Feature[");
        printf("%d", (pool_target->ent_feature)->identity);
        printf("] ");
    ...
    adm_pool_target_feature_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:1565:42) - Feature[");
        printf("%d", (pool_target->ent_feature)->identity);
        printf("] ");
    ...
    adm_pool_target_feature_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:1589:42) - Feature[");
        printf("%d", (pool_target->ent_feature)->identity);
        printf("] ");
    ...
    adm_pool_target_feature_typ * pool_target)
{
    ...
    if (
        ...
        printf(NEWLINE);
        printf("STATE (1:1635:42) - Feature[");
        printf("%d", (pool_target->ent_feature)->identity);
        printf("] ");
